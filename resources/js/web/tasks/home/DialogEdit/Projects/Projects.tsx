...
export default class Projects extends React.Component<ProjectsProps, ProjectsState>
{
    ...
    componentDidMount(): void {
        this.syncProjectSelected(this.props.projectSelected);
        this.search();
    }

    componentDidUpdate(prevProps: Readonly<ProjectsProps>) {
        if (prevProps.projectSelected?.id !== this.props.projectSelected?.id) {
            this.syncProjectSelected(this.props.projectSelected);
        }
    }

    syncProjectSelected(project: any) {
