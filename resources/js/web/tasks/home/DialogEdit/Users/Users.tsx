...
export default class Users extends React.Component<UsersProps, UsersState>
{
    ...
    componentDidMount(): void {
        this.syncUserSelected(this.props.userSelected); // récupère le user initial
        this.search();
    }

    componentDidUpdate(prevProps: Readonly<UsersProps>) {
        if (prevProps.userSelected?.id !== this.props.userSelected?.id) {
            this.syncUserSelected(this.props.userSelected);
        }
    }

    syncUserSelected(user: any) {
